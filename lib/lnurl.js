...
// Backwards-compat alias for callers that still import `lnAddrOptions`
// (api/resolvers/wallet.js sendToLnAddr and pages/withdraw.js). Dropped when
// those call sites move to the new helper.
export { fetchLnAddrOptions as lnAddrOptions }
