...
// the smallest amount a payer may send so the receiver's
// (100 - PROXY_RECEIVE_FEE_PERCENT)% payout still floors to >= 1 sat
export const PROXY_PAYER_MIN_MSATS = ceilBigInt(MIN_RECEIVE_MSATS * 100n, 100n - PROXY_RECEIVE_FEE_PERCENT)
