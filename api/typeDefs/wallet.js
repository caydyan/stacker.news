...
const typeDefs = gql`
  ...
  # Discriminated config input for a single wallet protocol. Exactly one
  # branch must be set; @oneOf enforces this at variable validation time and
  # the branch name identifies which protocol the resolver is upserting.
